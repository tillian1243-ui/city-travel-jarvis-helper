...
class MemoryStorage(Storage):
    ...
    def drive_status(self) -> dict[str, Any]:
        return {
            ...
            "auth_mode": "memory",
            "code": "OK",
            "detail": "In-memory export storage is available",
        }
